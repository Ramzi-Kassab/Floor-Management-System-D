...
|----------|---------|----------|
| MASTER_PLAN.md | Overall roadmap, Phase 1 data | docs/MASTER_PLAN.md |
| MASTER_PLAN_CORRECTION.md | Fix wrong seed data | docs/MASTER_PLAN_CORRECTION.md |
| PHASE2_PRODUCTS_IMPLEMENTATION.md | Phase 2 step-by-step guide | docs/PHASE2_PRODUCTS_IMPLEMENTATION.md |

### How to Use with Claude Code:
1. Upload documents to `docs/` folder in GitHub repo
2. Tell Claude Code: "Read docs/PHASE2_PRODUCTS_IMPLEMENTATION.md and start with Step 2.1"
3. Follow the step-by-step instructions
4. Commit with tags after each step
...
*Updated: December 12, 2025 - Added Claude.ai tips*
