    ...
    class Meta:
        ...
        widgets = {
            'code': forms.TextInput(attrs={
                ...
                'placeholder': 'Category code (e.g., PROC, SPEC)'
            }),
            ...
            'is_active': forms.CheckboxInput(attrs={
                'class': 'w-4 h-4 text-ardt-blue border-gray-300 rounded focus:ring-ardt-blue'
            }),
        }
...
class DocumentForm(forms.ModelForm):
    ...
    class Meta:
        model = Document
        fields = [
            'code', 'name', 'category', 'file',
            'version', 'revision_date', 'status',
            'description', 'keywords',
            'is_confidential', 'expires_at'
        ]
        widgets = {
            'code': forms.TextInput(attrs={
                'class': TAILWIND_INPUT,
                'placeholder': 'Document code (e.g., DOC-001)'
            }),
            'name': forms.TextInput(attrs={
                'class': TAILWIND_INPUT,
