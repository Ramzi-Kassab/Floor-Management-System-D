"""
ARDT FMS - Organization Forms
Version: 5.4

Form classes for organization management.
"""
...
class DepartmentForm(forms.ModelForm):
    ...
    class Meta:
        model = Department
        fields = ['code', 'name', 'name_ar', 'parent', 'manager', 'location', 'is_active']
        widgets = {
...
class PositionForm(forms.ModelForm):
    ...
    class Meta:
        model = Position
        fields = ['code', 'title', 'title_ar', 'department', 'level', 'description', 'is_active']
        widgets = {
            'code': forms.TextInput(attrs={
                'class': 'w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:border-gray-600 dark:text-white',
                'placeholder': 'TECH-SR'
...
class ThemeForm(forms.ModelForm):
    ...
    class Meta:
        model = Theme
        fields = ['code', 'name', 'primary_color', 'secondary_color', 'sidebar_color', 'is_dark', 'is_default', 'is_active']
        widgets = {
            'code': forms.TextInput(attrs={
                'class': 'w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:border-gray-600 dark:text-white',
                'placeholder': 'LIGHT'
            ...
            'is_dark': forms.CheckboxInput(attrs={
                'class': 'w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500'
            }),
...
class SystemSettingForm(forms.ModelForm):
    ...
    class Meta:
        model = SystemSetting
        fields = ['key', 'value', 'value_type', 'description', 'category', 'is_editable']
        widgets = {
