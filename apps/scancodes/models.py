...
class ScanCode(models.Model):
    ...
    created_by = models.ForeignKey(
        settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, null=True, related_name="created_scan_codes"
    )
...
class ScanLog(models.Model):
    ...
    scan_code = models.ForeignKey(ScanCode, on_delete=models.SET_NULL, null=True, related_name="scan_logs")
