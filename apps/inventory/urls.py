...
urlpatterns = [
    ...
    path("cutters/export/", views.CutterInventoryExportView.as_view(), name="cutter_inventory_export"),
    ...
    path("stock/export/excel/", views.StockExportExcelView.as_view(), name="stock_export_excel"),
