...
from .models import User, Role, Permission, RolePermission, UserRole, UserPreference
...
class UserAdmin(BaseUserAdmin):
    ...
    fieldsets = BaseUserAdmin.fieldsets + (
        ...
        ('Contact', {
            'fields': ('phone', 'phone_extension', 'mobile')
        }),
        ('Profile', {
            'fields': ('profile_photo', 'signature', 'language', 'timezone', 'theme')
        }),
    )
