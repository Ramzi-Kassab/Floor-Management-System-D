...
class EmployeeForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = [
            ...
            'department', 'position', 'job_title', 'job_description', 'manager', 'work_location',
        ...
        widgets = {
            ...
            'position': forms.Select(attrs={'class': TAILWIND_SELECT}),
            'job_title': forms.TextInput(attrs={'class': TAILWIND_INPUT,
                         'placeholder': 'Display title (e.g. Senior PDC Technician)'}),
