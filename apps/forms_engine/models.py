...
class FormTemplate(models.Model):
    ...
    created_by = models.ForeignKey(
        settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, null=True, related_name="created_form_templates"
    )
...
class FormField(models.Model):
    ...
    options = models.JSONField(null=True, blank=True, help_text='[{"value": "A", "label": "Option A"}, ...]')
    ...
    # Display
    sequence = models.IntegerField(default=0)
    width = models.CharField(max_length=20, default="full", help_text="full, half, third, quarter")
