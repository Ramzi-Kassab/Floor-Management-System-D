...
class MaintenanceWorkOrder(models.Model):
    ...
    request = models.ForeignKey(
        MaintenanceRequest, on_delete=models.SET_NULL, null=True, blank=True, related_name="work_orders"
    )
    ...
    assigned_to = models.ForeignKey(
        settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, null=True, blank=True, related_name="assigned_mwos"
    )
    ...
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    created_by = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, null=True, related_name="created_mwos")
...
class MaintenancePartsUsed(models.Model):
    ...
    mwo = models.ForeignKey(MaintenanceWorkOrder, on_delete=models.CASCADE, related_name="parts_used")
    inventory_item = models.ForeignKey("inventory.InventoryItem", on_delete=models.PROTECT, related_name="maintenance_usage")
